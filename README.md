...
A as test result on Oracle database in guest virtual machine, to generate 2.5 millions records into a file with 750 MB size, only takes external 3 seconds on writing, total time cost is 25 seconds.<br/>
